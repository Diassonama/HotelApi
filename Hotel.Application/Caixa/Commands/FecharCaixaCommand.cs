...
{
    public class FecharCaixaCommand:CaixaCommandBase
    {
        public class AdicionarEntradaCommandHandler : IRequestHandler<FecharCaixaCommand, BaseCommandResponse>
        {
            ...
            public async Task<BaseCommandResponse> Handle(FecharCaixaCommand request, CancellationToken cancellationToken)
            {
