...
{
    public class TransferenciaQuarto
    {
        ...
        /*  public int QuartoDestinoId { get; set; }
         public Apartamentos ApartamentoDestino { get; set; }
  */
        public TipoTransferencia TipoTransferencia { get; set; }
        public Boolean ManterPreco { get; set; } = true;

        public float ValorDiaria { get; set; }
        /*  public float ValorDiariaOrigem { get; set; }
         public float ValorDiariaDestino { get; set; } */
