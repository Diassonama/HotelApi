...
{
    public class GerarRelatorioContasPagarQuery : IRequest<BaseCommandResponse>
    {
        public int? EmpresaId { get; set; }
        public DateTime? DataInicio { get; set; }
        public DateTime? DataFim { get; set; }

        public class Handler : IRequestHandler<GerarRelatorioContasPagarQuery, BaseCommandResponse>
        {
            ...
            public async Task<BaseCommandResponse> Handle(GerarRelatorioContasPagarQuery request, CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    var contas = await _uow.ContasPagar.GetRelatorioAsync(
                        request.EmpresaId,
                        request.DataInicio,
                        request.DataFim);
                    ...
                    var dtos = contas.Select(c => new ContaPagarDto
                    {
                        ...
                        NomeEmpresa = c.EmpresaId.HasValue ? c.Empresa?.RazaoSocial : null,
                    ...
                    var pdf = _relatorioService.GerarRelatorioContasPagar(
                        dtos,
                        request.DataInicio,
                        request.DataFim,
                        filtroEmpresa);
